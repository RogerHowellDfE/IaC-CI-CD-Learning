...
var namePrefix = 'xyz-tutorial-03'
var namePrefixAlphanumeric = 'xyztut03' // all lowercase alphanumeric, max 11 chars long (max 24chars when combined with 13char resource name suffix)
