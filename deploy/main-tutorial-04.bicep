...
var namePrefix = 'xyz-tutorial-04'
var namePrefixAlphanumeric = 'xyztut04' // all lowercase alphanumeric, max 11 chars long (max 24chars when combined with 13char resource name suffix)
